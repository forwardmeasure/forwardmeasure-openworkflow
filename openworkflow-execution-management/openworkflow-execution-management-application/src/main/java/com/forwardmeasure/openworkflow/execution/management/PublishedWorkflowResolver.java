...
/** Definition-plane port which authorizes and resolves only a published immutable revision. */
@FunctionalInterface
public interface PublishedWorkflowResolver {
  PublishedWorkflow resolveAuthorizedPublished(
