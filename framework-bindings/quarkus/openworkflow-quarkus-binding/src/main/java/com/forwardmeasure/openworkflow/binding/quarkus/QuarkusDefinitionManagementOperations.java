...
/** Quarkus-managed transactional boundary around the portable JPA operations. */
@Singleton
@Transactional
public class QuarkusDefinitionManagementOperations extends JpaDefinitionManagementOperations {
  public QuarkusDefinitionManagementOperations(
