...
/**
 * Translates every {@link DefinitionManagementException} into a {@link Problem} response. Every
 * resource method just throws; nothing manually builds a {@code Response} for these failures.
 */
@Provider
public final class DefinitionManagementExceptionMapper
    implements ExceptionMapper<DefinitionManagementException> {

  @Override
  public Response toResponse(DefinitionManagementException exception) {
    int status =
  ...
  private static String title(DefinitionManagementException.Status status) {
