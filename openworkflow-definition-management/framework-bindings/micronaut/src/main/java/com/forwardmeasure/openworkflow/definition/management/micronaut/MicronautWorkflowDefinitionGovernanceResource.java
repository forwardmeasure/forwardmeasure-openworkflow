 ...
 * inherited from the generated {@code WorkflowDefinitionGovernanceApi} interface via {@code
 * micronaut-jaxrs-server}.
 */
@Singleton
public final class MicronautWorkflowDefinitionGovernanceResource
    extends WorkflowDefinitionGovernanceResource {

  @Inject
  public MicronautWorkflowDefinitionGovernanceResource(
