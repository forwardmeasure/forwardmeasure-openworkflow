 ...
 * inherited from the generated {@code WorkflowsApi} interface via {@code micronaut-jaxrs-server}.
 */
@Singleton
public final class MicronautWorkflowManagementResource extends WorkflowManagementResource {

  @Inject
  public MicronautWorkflowManagementResource(
