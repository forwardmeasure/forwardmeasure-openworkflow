...
/** Hibernate-backed implementation of {@link WorkflowReviewRepository}. */
public final class JpaWorkflowReviewRepository extends AbstractBaseRepository<WorkflowReview, Long>
    implements WorkflowReviewRepository {
  private final WorkflowActorResolver actors;

  public JpaWorkflowReviewRepository(EntityManager entityManager) {
  ...
  public WorkflowReview record(
    ...
    WorkflowReview review =
        new WorkflowReview(definition, reviewAction, actor, definitionDigest, reason);
    persist(review);
    return review;
  }
}
