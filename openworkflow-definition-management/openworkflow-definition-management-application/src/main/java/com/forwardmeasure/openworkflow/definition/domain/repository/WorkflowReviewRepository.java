...
/**
 * Persistence port for {@link WorkflowReview} — append-only maker-checker decisions. No API
 * operation reads review history back, so this is record-only, no {@code find}.
 */
public interface WorkflowReviewRepository {
  WorkflowReview record(
