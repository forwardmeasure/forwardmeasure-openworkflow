...
/**
 * Persistence port for {@link WorkflowLifecycleHistory} — append-only audit trail. No API operation
 * reads it back, so this is record-only, no {@code find}.
 */
public interface WorkflowLifecycleHistoryRepository {
  WorkflowLifecycleHistory record(
