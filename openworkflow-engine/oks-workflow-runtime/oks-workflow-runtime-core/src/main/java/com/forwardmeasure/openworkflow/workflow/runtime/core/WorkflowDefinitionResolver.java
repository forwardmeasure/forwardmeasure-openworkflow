...
/** Resolves one immutable, admitted OpenWorkflow definition revision. */
@FunctionalInterface
public interface WorkflowDefinitionResolver {
  WorkflowDefinitionBundle resolve(WorkflowDefinitionReference reference);
}
/*
