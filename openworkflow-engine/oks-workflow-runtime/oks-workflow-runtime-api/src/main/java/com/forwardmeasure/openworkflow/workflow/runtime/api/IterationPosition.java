...
public record IterationPosition(
    String taskPath, String itemVariable, String indexVariable, int index, DataReference item) {

  public IterationPosition {
    taskPath = requireText(taskPath, "taskPath");
