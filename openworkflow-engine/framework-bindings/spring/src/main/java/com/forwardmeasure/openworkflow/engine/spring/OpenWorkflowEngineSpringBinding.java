 ...
 */
package com.forwardmeasure.openworkflow.engine.spring;
...
/**
 * Spring composition for the durable execution engine (Kafka Streams) and the command-orchestration
 * service built on top of it. Not capability-specific: {@code ExecutionContextProvider}, the
 * query-side store, and the REST resource composition live in {@code
 * openworkflow-execution-management}'s own nested binding instead.
 */
@Configuration(proxyBeanMethods = false)
public class OpenWorkflowEngineSpringBinding {
