...
/** Resolves the exact immutable child plan pinned into an admitted parent workflow. */
@FunctionalInterface
public interface SubworkflowPlanResolver {
  WorkflowPlan resolve(TenantId tenantId, ActorIdentity actor, ResolvedSubflow subflow);
}
