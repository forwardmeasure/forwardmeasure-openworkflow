...
/** Transport adapter port; operationId is the mandatory publication idempotency key. */
@FunctionalInterface
public interface CloudEventPublisher {
  CompletionStage<Void> publish(String operationId, WorkflowCloudEvent event);
}
