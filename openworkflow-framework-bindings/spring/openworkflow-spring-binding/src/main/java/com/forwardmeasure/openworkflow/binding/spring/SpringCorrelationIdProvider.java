...
/** Reads {@code X-Correlation-ID} from the request-scoped servlet request Jersey runs on. */
public record SpringCorrelationIdProvider(HttpServletRequest request)
    implements CorrelationIdProvider {

  public SpringCorrelationIdProvider {
