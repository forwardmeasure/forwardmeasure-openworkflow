...
/** Forces the selected execution plane to start with the Quarkus application. */
@Startup
@ApplicationScoped
public class QuarkusPekkoStartup {
  private final ExecutionEngineProvider provider;

  public QuarkusPekkoStartup(ExecutionEngineProvider provider) {
