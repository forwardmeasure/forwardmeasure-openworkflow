 ...
 */
package com.forwardmeasure.openworkflow.operation.cassandra;
...
/** Starts durable-offset Cassandra HTTP and protocol operation projections. */
public final class CassandraOperationOutboxes {
  private CassandraOperationOutboxes() {}
  ...
  public static void startHttp(
    ...
    start(
        system,
        "openworkflow-http-operations-cassandra",
  ...
  public static void startProtocol(
    ...
    start(
        system,
        "openworkflow-protocol-operations-cassandra",
            ...
            index -> {
              ...
              return ProjectionBehavior.create(
                  CassandraProjection.atLeastOnce(
                          ProjectionId.of(projectionName, tag), source, () -> handlers.apply(tag))
